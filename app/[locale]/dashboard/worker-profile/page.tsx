...
// claimed). Server-rendered form posting to upsertMyWorkerProfile (which claims any
// matching unclaimed profile first, then upserts). No directory/search/staffing here.
