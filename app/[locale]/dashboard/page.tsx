...
export default async function CommandCenterPage({ params, searchParams }: Props) {
  ...
  const quick = [
    { icon: Plus, label: tc('quick.createActivity'), href: `/${locale}/plan-an-event`, c: 'bg-indigo-50 text-indigo-600' },
      ...
      <section>
        <div className="mb-3 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-sm font-semibold text-brand-600">
            <Link href={`/${locale}/plan-an-event`} className="hover:underline">Create activity</Link>
        ...
        {projects.length === 0 ? (
          <div className="overflow-hidden rounded-2xl bg-gradient-to-br from-brand-600 to-brand-800 p-6 text-white sm:p-8">
            ...
            <Link href={`/${locale}/plan-an-event`} className="mt-5 inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-bold text-brand-700 hover:bg-brand-50">
